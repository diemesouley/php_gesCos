<?php
  $page_title = 'Modification produit';
      ...
      if (is_null($_POST['product-location']) || $_POST['product-location'] === "") {
       ...
       $result = $db->query($query);
               if($result && $db->affected_rows() === 1){
                 ...
                 $session->msg('d',' Désolé de ne pas avoir mis à jour!');
           ...
           <form method="post" action="edit_product.php?id=<?php echo (int)$product['id'] ?>">
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="product-title" value="<?php echo remove_junk($product['nom']);?>">
               </div>
              </div>
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="product-desc" value="<?php echo remove_junk($product['description']);?>" placeholder="Produit Description">
               </div>
              </div>
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="product-location" value="<?php echo remove_junk($product['location']);?>" placeholder="Produit Location">
               </div>
              </div>
              ...
              <div class="form-group">
               <div class="row">
                 ...
                 <div class="col-md-4">
                  <div class="form-group">
                    <label for="qty">Prix de revient</label>
                    <div class="input-group">
                      <span class="input-group-addon">
