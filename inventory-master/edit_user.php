...
<?php
  ...
  if(!$e_user){
    $session->msg("d","Identifiant utilisateur manquant.");
    redirect('users.php');
  }
?>
     ...
     $h_pass   = sha1($password);
       ...
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          ...
          $session->msg('d',' Désolé de ne pas avoir mis à jour le mot de passe utilisateur!');
          redirect('edit_user.php?id='.(int)$e_user['id'], false);
        }
  } else {
    $session->msg("d", $errors);
...
<!--     *************************     -->
       <div class="panel-heading">
        <strong>
          ...
          Mise à jour <?php echo remove_junk(ucwords($e_user['name'])); ?> Compte
        </strong>
       </div>
<!--     *************************     -->
            ...
            <div class="form-group">
              <label for="status">Status</label>
                <select class="form-control" name="status">
                  ...
                  <option <?php if($e_user['status'] === '0') echo 'selected="selected"';?> value="0">Deactivé</option>
                </select>
            </div>
<!--     *************************     -->
      ...
      <div class="panel-body">
        <form action="edit_user.php?id=<?php echo (int)$e_user['id'];?>" method="post" class="clearfix">
          <div class="form-group">
                ...
                <input type="password" class="form-control" name="password" placeholder="Saisissez le nouveau mot de passe de l'utilisateur">
          </div>
          <div class="form-group clearfix">
