...
<!--     *************************     -->
          <span>Journal inventaire</span>
<!--     *************************     -->
       </strong>
          <div class="pull-right">
            <a href="add_stock.php" class="btn btn-primary">Ajouter un stock</a>
          </div>
      </div>
        <div class="panel-body">
          <table class="table table-bordered table-striped table-hover">
            <thead>
                <tr>
                    <th class="text-center" style="width: 50px;">Produit</th>
...
<?php foreach ($all_stock as $stock):?>
                <tr>
                    ...
                    <td class="text-center">
                      <div class="btn-group">
                        <a href="edit_stock.php?id=<?php echo (int)$stock['id'];?>"  class="btn btn-xs btn-warning" data-toggle="tooltip" title="modifier">
                          <span class="glyphicon glyphicon-edit"></span>
                        </a>
                        <a href="delete_stock.php?id=<?php echo (int)$stock['id'];?>" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-xs btn-danger" data-toggle="tooltip" title="Retirer">
