...
if(isset($_POST['edit_stock'])){
  ...
  if(empty($errors))
  {
     ...
     if($result && $db->affected_rows() === 1)
     {
	   ...
	   $session->msg("s", " Mise à jour réussie");
       redirect('stock.php',false);
     } else {
       $session->msg("d", " Pardon! Échoué");
     ...
     <div class="panel panel-default">
       <div class="panel-heading">
         <strong>
           ...
           <span>Édition <?php echo remove_junk(ucfirst($stock['product_id']));?></span>
        </strong>
       </div>
       <div class="panel-body">
         <form method="post" action="">
           ...
           <button type="submit" name="edit_stock" class="btn btn-primary">Mettre à jour l'inventaire</button>
       </form>
       </div>
     </div>
