  ...
  if(isset($_POST['add_sale'])){
    ...
    validate_fields($req_fields);
        if(empty($errors)){
          ...
          $s_qty     = $db->escape((int)$_POST['quantité']);

			$product = find_by_id("products", $p_id);
			if ( (int)$product[quantity] < $s_qty )
			{	
                  $session->msg('d',' Quantité insuffisante à vendre!');
          ...
          $sql .= ")";
                ...
                if($db->query($sql)){
                  ...
                  $session->msg('d',' Désolé n\'a pas pu ajouter!');
                  redirect('add_sale.php', false);
                }
        } else {
        ...
        <div class="form-group">
          <div class="input-group">
            <span class="input-group-btn">
              <button type="submit" class="btn btn-primary">Trouve le</button>
            </span>
