    ...
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        <strong>
          ...
          <span>Ajouter des ventes à la commande #<?php echo $order_id; ?></span>
       </strong>
      </div>
...
<td id="s_qty">
                   <div class="input-group">
                     ...
                     <input type="number" class="form-control" name="quantity" placeholder="Quantite du produit">
                  </div>
                 </div>
