                ...
                <tr>
                    ...
                    <td class="text-center">
                      <div class="btn-group">
                        ...
                        <a href="delete_categorie.php?id=<?php echo (int)$cat['id'];?>"  onClick="return confirm('Are you sure you want to delete?')" class="btn btn-xs btn-danger" data-toggle="tooltip" title="Remove">
